...
Begin VB.Form frmLogin 
   ...
   Begin VB.PictureBox bgHWND 
      ...
      Width           =   15
   End
   Begin lvButton.lvButtons_H cmdLog 
      Default         =   -1  'True
      Height          =   330
      Left            =   4440
      TabIndex        =   10
...
Set rsData = CN.Execute("Select * from tblAccount where username='" & txtUserName.Text & "'")
    With rsData
        If .BOF = True And .EOF = True Then
             ...
             SendKeys "{Home}+{End}"
        Else
               If DeCode(txtPassword.Text) = DeCode(!Password) Then
                ...
                frmWelcome.timerUT.Enabled = True
                frmWelcome.lblUserNames = CurrUser.UserNAME
                Unload Me
            Else
                verify_attempt
                attempt = attempt + 1
...
With rsData
    CurrBusinessInfo.BusinessName = !Name
    CurrBusinessInfo.BusinessAddress = !Address
End With
Set rsData = Nothing
End Sub
