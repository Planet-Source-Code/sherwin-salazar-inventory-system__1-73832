...
rsData.Open "Select * from tblSupplier", CN, adOpenStatic, adLockPessimistic
With rsData
    While Not .EOF
                Dim LS As ListItem
                Set LS = ListView1.ListItems.Add(, , rsData!SupplierCode, 1, 1)
                    LS.SubItems(1) = rsData!SupplierName
                    LS.SubItems(2) = rsData!ContactNos
                    LS.SubItems(3) = rsData!Address
                    LS.SubItems(4) = rsData!ContactPerson
                    LS.SubItems(5) = rsData!Positions
...
Case "Edit"
            ...
            Set rsData = New ADODB.Recordset
            rsData.Open "Select * from tblSupplier where SupplierCode = '" & ListView1.SelectedItem.Text & "'", CN, adOpenStatic, adLockPessimistic
            If rsData.RecordCount < 1 Then Exit Sub
            With frmSupplier
                .EditFlag = False
                .Text1.Text = rsData.Fields("SupplierCode")
                .Text2.Text = rsData.Fields("SupplierName")
...
Case "Delete"
           ...
           If ListView1.ListItems.Count < 1 Then
            ...
            If wheng = vbYes Then
            CN.Execute ("Delete from  tblSupplier where SupplierCode= '" & ListView1.SelectedItem.Text & "'")
            LoadEntries
