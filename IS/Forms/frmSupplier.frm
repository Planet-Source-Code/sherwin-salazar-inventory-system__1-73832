...
With frmSuppliers.rsData
    If EditFlag = True Then .AddNew
        .Fields("SupplierCode") = Text1.Text
        .Fields("SupplierName") = Text2.Text
...
End With
    ...
    If EditFlag = True Then
        Call FindRec(frmSuppliers.rsData, "SupplierCode", True, Text1.Text, 0)
...
Dim iCode  As Long
    ...
    Text1.Text = GenerateID(iCode, "SUPP-", "00000")
End Sub
