...
With frmCategorys.rsData
    If EditFlag = True Then .AddNew
        .Fields("CatCode") = Text1.Text
        .Fields("categoryname") = Text2.Text
        .Fields("Description") = Text3.Text
      .Update
End With

    If EditFlag = True Then
        Call FindRec(frmCategorys.rsData, "CatCode", True, Text1.Text, 0)
...
Sub GeneratePK()
Dim iCode  As Long
    iCode = getIndex("tblCategory")
    Text1.Text = GenerateID(iCode, "CAT-", "00000")
End Sub
